...
from model.recognition_models import RecWaveNetText as RecognitionModel
import json
import os
import sys
...
if pre_trained:
    ...
    out_dir = os.path.join(PATHS['save_dir'], 'wavenet_reconstruction_output_lang_{}_{}'.format(lang, timestamp))
